...
class SerialAtTests(unittest.TestCase):
    ...
    def test_builds_verified_private_zero_and_flash_save_frames(self) -> None:
        # CAN ID 6, host ID 0xFD。Type 6=原点、Type 22=本体保存。
        self.assertEqual(
            build_set_mechanical_zero_command(0x34).hex(" "),
            "41 54 37 e8 00 34 08 00 00 00 00 00 00 00 00 0d 0a",
        )
        self.assertEqual(
            build_save_motor_data_command(0x34).hex(" "),
            "41 54 b7 e8 00 34 08 00 00 00 00 00 00 00 00 0d 0a",
        )
